...
export default function Createcampaign() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axiosAuth.get(`/ticketdetails?populate=*&filters[movieid][$eq]=${movieid}`)
    ...
    return (
        <div>
            <div className="container mx-auto max-w-md mt-4">
                <h1 className="text-center text-2xl font-semibold mb-4">Add Ticket details for this movie</h1>
